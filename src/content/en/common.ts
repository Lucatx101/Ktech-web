...
const en = {
  ...
  about: {
    eyebrow: "ABOUT KTECH",
    heading: "From engineering ideas to practical industrial solutions",
    paragraphs: [
  ...
  capabilities: {
    ...
    heading: "Integrated capabilities from data to production",
    introduction:
    ...
    items: {
      ...
      automationSpecialMachinery: {
        title: "Automation and Special-Purpose Machinery",
        description:
      ...
      automotiveSupport: {
        title: "Automotive Industry Support Equipment",
        description:
